"""
MODDED: This is a modified version of the original train.py script.
It can be  used to train the splitGPT model, if the split flag is set to True.
Modidied parts are marked with # MODDED # and # END MODDED #.
"""
